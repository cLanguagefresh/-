...
void Dht11(void)
{
	...
	//{
		...
		//	OLED_ShowString(2, 7, ".");
		//	OLED_ShowNum(2, 8, DHT11_Data.humi_deci, 2);
			
			OLED_ShowNum(1, 6, DHT11_Data.temp_int, 2);
			OLED_ShowString(1, 8, ".");
			OLED_ShowNum(1, 9, DHT11_Data.temp_deci, 1);
			
			temperature = DHT11_Data.temp_int + DHT11_Data.temp_deci / 10.0f;
			humidity = DHT11_Data.humi_int + DHT11_Data.humi_deci / 10.0f;
