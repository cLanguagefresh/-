...
if (NOT TARGET Qt5::Gamepad)
    ...
    _populate_Gamepad_target_properties(RELEASE "Qt5Gamepad.dll" "libQt5Gamepad.a" FALSE)

    if (EXISTS
        "${_qt5Gamepad_install_prefix}/bin/Qt5Gamepad.dll"
      AND EXISTS
        "${_qt5Gamepad_install_prefix}/lib/libQt5Gamepad.a" )
        _populate_Gamepad_target_properties(DEBUG "Qt5Gamepad.dll" "libQt5Gamepad.a" FALSE)
    endif()
