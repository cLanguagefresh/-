...
set(Qt5Quick3D_VERSION_STRING 5.14.2)
...
if (NOT TARGET Qt5::Quick3D)
    ...
    set(Qt5Quick3D_PRIVATE_INCLUDE_DIRS
        "${_qt5Quick3D_install_prefix}/include/QtQuick3D/5.14.2"
        "${_qt5Quick3D_install_prefix}/include/QtQuick3D/5.14.2/QtQuick3D"
    )
    ...
    foreach(_module_dep ${_Qt5Quick3D_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.2 ${_Qt5Quick3D_FIND_VERSION_EXACT}
    ...
    _populate_Quick3D_target_properties(RELEASE "Qt5Quick3D.dll" "libQt5Quick3D.a" FALSE)

    if (EXISTS
        "${_qt5Quick3D_install_prefix}/bin/Qt5Quick3D.dll"
      AND EXISTS
        "${_qt5Quick3D_install_prefix}/lib/libQt5Quick3D.a" )
        _populate_Quick3D_target_properties(DEBUG "Qt5Quick3D.dll" "libQt5Quick3D.a" FALSE)
    endif()
