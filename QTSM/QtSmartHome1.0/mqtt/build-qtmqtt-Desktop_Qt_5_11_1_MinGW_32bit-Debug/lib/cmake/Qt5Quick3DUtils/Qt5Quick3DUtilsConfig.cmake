...
set(Qt5Quick3DUtils_VERSION_STRING 5.14.2)
...
if (NOT TARGET Qt5::Quick3DUtils)
    ...
    set(Qt5Quick3DUtils_PRIVATE_INCLUDE_DIRS
        "${_qt5Quick3DUtils_install_prefix}/include/QtQuick3DUtils/5.14.2"
        "${_qt5Quick3DUtils_install_prefix}/include/QtQuick3DUtils/5.14.2/QtQuick3DUtils"
    )
    ...
    foreach(_module_dep ${_Qt5Quick3DUtils_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.2 ${_Qt5Quick3DUtils_FIND_VERSION_EXACT}
    ...
    _populate_Quick3DUtils_target_properties(RELEASE "Qt5Quick3DUtils.dll" "libQt5Quick3DUtils.a" FALSE)

    if (EXISTS
        "${_qt5Quick3DUtils_install_prefix}/bin/Qt5Quick3DUtils.dll"
      AND EXISTS
        "${_qt5Quick3DUtils_install_prefix}/lib/libQt5Quick3DUtils.a" )
        _populate_Quick3DUtils_target_properties(DEBUG "Qt5Quick3DUtils.dll" "libQt5Quick3DUtils.a" FALSE)
    endif()
