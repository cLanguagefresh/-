...
if (NOT TARGET Qt5::Scxml)
    ...
    _populate_Scxml_target_properties(RELEASE "Qt5Scxml.dll" "libQt5Scxml.a" FALSE)

    if (EXISTS
        "${_qt5Scxml_install_prefix}/bin/Qt5Scxml.dll"
      AND EXISTS
        "${_qt5Scxml_install_prefix}/lib/libQt5Scxml.a" )
        _populate_Scxml_target_properties(DEBUG "Qt5Scxml.dll" "libQt5Scxml.a" FALSE)
    endif()
