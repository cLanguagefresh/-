...
if (NOT TARGET Qt5::RemoteObjects)
    ...
    _populate_RemoteObjects_target_properties(RELEASE "Qt5RemoteObjects.dll" "libQt5RemoteObjects.a" FALSE)

    if (EXISTS
        "${_qt5RemoteObjects_install_prefix}/bin/Qt5RemoteObjects.dll"
      AND EXISTS
        "${_qt5RemoteObjects_install_prefix}/lib/libQt5RemoteObjects.a" )
        _populate_RemoteObjects_target_properties(DEBUG "Qt5RemoteObjects.dll" "libQt5RemoteObjects.a" FALSE)
    endif()
