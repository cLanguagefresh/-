...
if (NOT TARGET Qt5::3DAnimation)
    ...
    _populate_3DAnimation_target_properties(RELEASE "Qt53DAnimation.dll" "libQt53DAnimation.a" FALSE)

    if (EXISTS
        "${_qt53DAnimation_install_prefix}/bin/Qt53DAnimation.dll"
      AND EXISTS
        "${_qt53DAnimation_install_prefix}/lib/libQt53DAnimation.a" )
        _populate_3DAnimation_target_properties(DEBUG "Qt53DAnimation.dll" "libQt53DAnimation.a" FALSE)
    endif()
