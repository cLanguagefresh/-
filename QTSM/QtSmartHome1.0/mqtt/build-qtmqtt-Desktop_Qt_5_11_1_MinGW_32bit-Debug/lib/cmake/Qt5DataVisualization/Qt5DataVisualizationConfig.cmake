...
if (NOT TARGET Qt5::DataVisualization)
    ...
    _populate_DataVisualization_target_properties(RELEASE "Qt5DataVisualization.dll" "libQt5DataVisualization.a" FALSE)

    if (EXISTS
        "${_qt5DataVisualization_install_prefix}/bin/Qt5DataVisualization.dll"
      AND EXISTS
        "${_qt5DataVisualization_install_prefix}/lib/libQt5DataVisualization.a" )
        _populate_DataVisualization_target_properties(DEBUG "Qt5DataVisualization.dll" "libQt5DataVisualization.a" FALSE)
    endif()
