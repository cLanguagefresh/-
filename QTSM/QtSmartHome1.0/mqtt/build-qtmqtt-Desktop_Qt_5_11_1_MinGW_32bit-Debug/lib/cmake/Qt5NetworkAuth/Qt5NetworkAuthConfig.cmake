...
set(Qt5NetworkAuth_VERSION_STRING 5.14.2)
...
if (NOT TARGET Qt5::NetworkAuth)
    ...
    set(Qt5NetworkAuth_PRIVATE_INCLUDE_DIRS
        "${_qt5NetworkAuth_install_prefix}/include/QtNetworkAuth/5.14.2"
        "${_qt5NetworkAuth_install_prefix}/include/QtNetworkAuth/5.14.2/QtNetworkAuth"
    )
    ...
    foreach(_module_dep ${_Qt5NetworkAuth_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.2 ${_Qt5NetworkAuth_FIND_VERSION_EXACT}
    ...
    _populate_NetworkAuth_target_properties(RELEASE "Qt5NetworkAuth.dll" "libQt5NetworkAuth.a" FALSE)

    if (EXISTS
        "${_qt5NetworkAuth_install_prefix}/bin/Qt5NetworkAuth.dll"
      AND EXISTS
        "${_qt5NetworkAuth_install_prefix}/lib/libQt5NetworkAuth.a" )
        _populate_NetworkAuth_target_properties(DEBUG "Qt5NetworkAuth.dll" "libQt5NetworkAuth.a" FALSE)
    endif()
