...
if (NOT TARGET Qt5::3DExtras)
    ...
    _populate_3DExtras_target_properties(RELEASE "Qt53DExtras.dll" "libQt53DExtras.a" FALSE)

    if (EXISTS
        "${_qt53DExtras_install_prefix}/bin/Qt53DExtras.dll"
      AND EXISTS
        "${_qt53DExtras_install_prefix}/lib/libQt53DExtras.a" )
        _populate_3DExtras_target_properties(DEBUG "Qt53DExtras.dll" "libQt53DExtras.a" FALSE)
    endif()
