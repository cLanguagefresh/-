...
if (NOT TARGET Qt5::VirtualKeyboard)
    ...
    _populate_VirtualKeyboard_target_properties(RELEASE "Qt5VirtualKeyboard.dll" "libQt5VirtualKeyboard.a" FALSE)

    if (EXISTS
        "${_qt5VirtualKeyboard_install_prefix}/bin/Qt5VirtualKeyboard.dll"
      AND EXISTS
        "${_qt5VirtualKeyboard_install_prefix}/lib/libQt5VirtualKeyboard.a" )
        _populate_VirtualKeyboard_target_properties(DEBUG "Qt5VirtualKeyboard.dll" "libQt5VirtualKeyboard.a" FALSE)
    endif()
