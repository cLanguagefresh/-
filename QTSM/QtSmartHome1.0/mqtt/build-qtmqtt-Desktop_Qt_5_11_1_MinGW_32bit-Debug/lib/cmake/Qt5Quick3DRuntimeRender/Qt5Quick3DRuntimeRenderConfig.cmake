...
set(Qt5Quick3DRuntimeRender_VERSION_STRING 5.14.2)
...
if (NOT TARGET Qt5::Quick3DRuntimeRender)
    ...
    set(Qt5Quick3DRuntimeRender_PRIVATE_INCLUDE_DIRS
        "${_qt5Quick3DRuntimeRender_install_prefix}/include/QtQuick3DRuntimeRender/5.14.2"
        "${_qt5Quick3DRuntimeRender_install_prefix}/include/QtQuick3DRuntimeRender/5.14.2/QtQuick3DRuntimeRender"
    )
    ...
    foreach(_module_dep ${_Qt5Quick3DRuntimeRender_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.2 ${_Qt5Quick3DRuntimeRender_FIND_VERSION_EXACT}
    ...
    _populate_Quick3DRuntimeRender_target_properties(RELEASE "Qt5Quick3DRuntimeRender.dll" "libQt5Quick3DRuntimeRender.a" FALSE)

    if (EXISTS
        "${_qt5Quick3DRuntimeRender_install_prefix}/bin/Qt5Quick3DRuntimeRender.dll"
      AND EXISTS
        "${_qt5Quick3DRuntimeRender_install_prefix}/lib/libQt5Quick3DRuntimeRender.a" )
        _populate_Quick3DRuntimeRender_target_properties(DEBUG "Qt5Quick3DRuntimeRender.dll" "libQt5Quick3DRuntimeRender.a" FALSE)
    endif()
