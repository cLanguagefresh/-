...
if (NOT TARGET Qt5::Charts)
    ...
    _populate_Charts_target_properties(RELEASE "Qt5Charts.dll" "libQt5Charts.a" FALSE)

    if (EXISTS
        "${_qt5Charts_install_prefix}/bin/Qt5Charts.dll"
      AND EXISTS
        "${_qt5Charts_install_prefix}/lib/libQt5Charts.a" )
        _populate_Charts_target_properties(DEBUG "Qt5Charts.dll" "libQt5Charts.a" FALSE)
    endif()
