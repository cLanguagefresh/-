...
set(Qt5Quick3DAssetImport_VERSION_STRING 5.14.2)
...
if (NOT TARGET Qt5::Quick3DAssetImport)
    ...
    set(Qt5Quick3DAssetImport_PRIVATE_INCLUDE_DIRS
        "${_qt5Quick3DAssetImport_install_prefix}/include/QtQuick3DAssetImport/5.14.2"
        "${_qt5Quick3DAssetImport_install_prefix}/include/QtQuick3DAssetImport/5.14.2/QtQuick3DAssetImport"
    )
    ...
    foreach(_module_dep ${_Qt5Quick3DAssetImport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.2 ${_Qt5Quick3DAssetImport_FIND_VERSION_EXACT}
    ...
    _populate_Quick3DAssetImport_target_properties(RELEASE "Qt5Quick3DAssetImport.dll" "libQt5Quick3DAssetImport.a" FALSE)

    if (EXISTS
        "${_qt5Quick3DAssetImport_install_prefix}/bin/Qt5Quick3DAssetImport.dll"
      AND EXISTS
        "${_qt5Quick3DAssetImport_install_prefix}/lib/libQt5Quick3DAssetImport.a" )
        _populate_Quick3DAssetImport_target_properties(DEBUG "Qt5Quick3DAssetImport.dll" "libQt5Quick3DAssetImport.a" FALSE)
    endif()
